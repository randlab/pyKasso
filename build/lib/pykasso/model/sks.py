...
##########################
    ...
    def _build_model_geology(self) -> None:
        ...
        self.geology = Geology(
            grid=self.grid,
            default_fmm_cost=self.model_parameters['sks']['costs']['geology'],
            **geology_settings,
        )
        return None
    ...
    def _build_model_faults(self) -> None:
        ...
        self.faults = Faults(
            grid=self.grid,
            default_fmm_cost=self.model_parameters['sks']['costs']['faults'],
            **faults_settings,
        )
        return None
    ...
    def _build_model_fractures(self) -> None:
        ...
        self.fractures = Fractures(
            ...
            default_fmm_cost=self.model_parameters['sks']['costs']['fractures'],
        )
        ...
        if 'generate' in fractures_settings:
            ...
            for frac_name, frac_settings in frac_settings.items():
                default_cost = self.model_parameters['sks']['costs']['fractures'],
