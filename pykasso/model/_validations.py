...
this.ATTRIBUTES = {
    'sks': {
        ...
        'costs': ['optional', {}],
        'mode': ['optional', 'A'],
        'factors': ['optional', {'F': 100, 'F1': 100, 'F2': 50}]
    },
    'grid': {
        'x0': ['required', ''],
        'y0': ['required', ''],
    ...
    'outlets': {
        ...
        'importance': ['required', []],
        'subdomain': ['optional', 'domain_bottom'],
    ...
    'inlets': {
        ...
        'importance': ['required', []],
        'per_outlet': ['required', []],
        'subdomain': ['optional', 'domain_surface'],
        'geology': ['optional', None],
        'seed': ['optional', 0],
    },
    'tracers': {}, # TODO ???
...
def validate_attribute_presence(settings, attribute, kind, default_value={},
                                is_subattribute=False) -> dict:
    """
    TODO
    """
    ...
    if attribute not in settings:
        ...
        if settings[attribute] is None:
            msg = ("The '{}' attribute is not defined ({})."
...
def is_attribute_type_valid(attribute: str, value, types):
    ...
    if not isinstance(value, types):
        msg = ("The value of the '{}' attribute must be of type : {}"
...
def is_attribute_value_valid(attribute: str, value: float, logical_test: str,
    ...
    if not eval(test):
        msg = ("The value of the '{}' attribute must be {} {}."
               .format(attribute,
...
def validate_settings(feature: str, feature_settings: dict, grid=None) -> dict:
    ...
    elif feature in ['geology', 'faults']:
